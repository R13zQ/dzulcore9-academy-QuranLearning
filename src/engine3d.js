...
class Engine3D {
  ...
  init() {
    ...
    try {
      ...
      const errorMsg = "WebGL tidak didukung atau diblokir di browser Anda (biasanya terjadi di Mode Incognito strict). Silakan gunakan tab normal browser Anda.";
      if (window.showDebugMsg) window.showDebugMsg(errorMsg, true);
      alert(errorMsg);
      throw err;
    }
